...
Finally, if we assume that an acceleration region, with cathode at $z^{\prime} = 0$ and anode at $z^{\prime}_A$ and acceleration potential $V$, has an on-axis force of the form
