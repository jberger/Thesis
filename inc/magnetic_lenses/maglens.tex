...
To further ease the burden on the lenses, I actually created two, one placed to either side of the RF cavity.
As each has 100 turns, a current of only 2A is needed to drive the two lenses in series.
The oxygen-free copper wire coils remain cool to the touch under these operating conditions.
