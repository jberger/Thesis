...
First, in this geometry, the walk-off angle between the fundamental and second harmonic is zero, while the group velocity mismatch of 150fs ($\sim$ 50 fs/mm) is still less than the pulse duration 250fs. %TODO cite Newlight Photonics, Canada
...
%TODO replace above with once oven temperature is known
%Second, because in this case, non-critically phase matching requires that the crystal is held at an elevated temperature of XXX$^{\circ}$C, the deleterious absorption of water in the hygroscopic LBO crystal is prevented.
...
Although the laser system had been relatively robust, maintaining mode-locking operation was initially problematic.
