...
\ref{fig:polepiece-design} shows a simplistic design schematic of the lens designed and built for the UEM at UIC.
The central bore is a tube of stainless steel having a magnetic permeability of 1; this behaves magnetically as if it is not involved in the field shaping.
In this way the inner bore of the tube is in vacuum with minimal welding necessary.
The outer diameter of tube is milled down to an outer diameter of $D=2R=$0.5in, though a disk of larger diameter, and length $S$=0.1in, is left at the midpoint, which will separate the shielding material and be the pole-piece gap.

The high magnetic permeability shielding is in eleven pieces.
There are two end pieces end pieces are revolution solid of ``L'' profile.
These ends are slid together touching the disk at the midpoint of the drift tube; the disk is of the proper outer diameter to match the sheilding's smaller outer diameter.
The combination of the two ends and this disk make a ``U'' shape which contains the windings.

The top side of the end's larger outer side is flattend on eight sides.
These are the mount points for eight bridge pieces which connect the ends, completing the field-capturing shielding loop.
...
I chose drift tube outer diameter to be $D=$0.5in and a pole-piece gap $S$=0.1in, for an ratio $S/D=0.2$.
