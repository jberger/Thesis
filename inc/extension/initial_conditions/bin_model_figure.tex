\begin{figure}
  ...
  \caption[Results of bin model for computing initial conditions]{
    ...
    Unfortunately, the model only allows for a constant local momentum variance $\eta_z$ (green) and in all but the extreme acceleration dominated case \subref{fig:bin_model_acc} the model cannot well represent the simulated data.
  }
  \label{fig:bin_model}
\end{figure}
