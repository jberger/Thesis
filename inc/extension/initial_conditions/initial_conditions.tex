...
%TODO describe new model
Careful analysis of the electron generation using the longitudinal $ v^{3} $ photoemission velocity distribution %TODO reference bin model
