...
Usefully, it also comes with a subclass of \verb!Physics::UEMColumn::Photoemission! which uses this model to generate the pulse's $z$ direction initial conditions.
