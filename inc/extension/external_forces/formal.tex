...
As this force is self-influencing, it is the major source of complexity in the model; indeed without this term, a complete analytic solutions is possible, which is identical to ``Gaussian'' optics~\cite{michalik_analytic_2006}.
