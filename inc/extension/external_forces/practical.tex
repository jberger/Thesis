...
To summarize, the additional terms are which are added to model internal pulse dynamics arising from a single RF cavity are
\begin{gather}
  ...
  \end{aligned}
\end{gather}
Additionally, an acceleration force term
\begin{equation}
...
\end{equation}
which originates from the leading term in \ref{eq:RF_Efield_approx}, should be added to the dynamics of the motion of the overall pulse.
