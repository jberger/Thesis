...
We note that, in the transverse directions ($\smallT$), this is consistent with the definition of `coherent fluence' employed by Reed \textit{et al.}~\cite{reed_evolution_2009} for time-resolved electron microscopy and, of course, the transverse spatial emittance of an electron beam~\cite{jensen_theoretical_2006,siwick_ultrafast_2002}.
...
This effect is called ``emittance growth'' and is most commonly seen in TEM as a result of aberrations in lens systems~\cite{oshea_reversible_1998}.
