...
As seen in Section \ref{sec:const_force}, this constant electric field does not affect the intrapulse dynamics, however the electric field that nears this aperture turns outward, causing the anode itself to act as a negative transverse lens. %TODO reference
