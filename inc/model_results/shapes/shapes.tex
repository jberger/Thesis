...
The bunch propagation dynamics for the negligible pulse charge density case shown in \ref{fig:compare_shape}\subref{fig:compare_shape_N1} display the trends expected from the initial photoemission conditions.
...
In all cases, this intrinsic electron pulse broadening due to non-zero $ \eta_{\alpha} $ generates a momentum chirp across the electron bunch; in the longitudinal dimension the faster electrons, those photoemitted with larger excess energy, lead the slower electrons.
