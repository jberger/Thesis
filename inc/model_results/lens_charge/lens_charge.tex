...
\begin{figure}
  ...
  \caption[AG model simulated focal behavior of perfect magnetic lenses as a function of pulse charge $N$]{
    ...
    Distance traveled in column is measured relative to the lens at $z=0$, in units of the focal lenth, \subref{fig:focus_lens_charge_long} $f = $ 60mm and \subref{fig:focus_lens_charge_short} $ f = $ 6.0mm.
