...
However, unlike in the dispersion limited case (\ref{fig:rf_cav_num}\subref{fig:rf_cav_N1}), the compressed pulse duration is now a factor of $\sim$4 less than the original 100fs laser pulse duration.
