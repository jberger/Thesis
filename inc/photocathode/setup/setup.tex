...
To address this need, I have experimented with several candidate photocathodes, which belong to several different categories of photoemission processes.
In this chapter, I will present an example of each of these different processes, and discuss its prospects for reducing the transverse emittance and therefore utility as an electron source for UEM.
